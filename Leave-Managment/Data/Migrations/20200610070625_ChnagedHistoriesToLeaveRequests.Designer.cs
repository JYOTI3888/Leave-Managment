...
namespace Leave_Managment.Data.Migrations
{
    ...
    [Migration("20200610070625_ChnagedHistoriesToLeaveRequests")]
    partial class ChnagedHistoriesToLeaveRequests
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Leave_Managment.Models.EditLeaveallocationVM", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Leave_Managment.Models.LeaveAllocationVM", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Leave_Managment.Models.LeaveTypeViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Leave_Managment.Models.EditLeaveallocationVM", b =>
                {
                    b.HasOne("Leave_Managment.Models.EmployeeVM", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("Leave_Managment.Models.LeaveTypeViewModel", "LeaveType")
                        .WithMany()
                        .HasForeignKey("LeaveTypeId");
                });
